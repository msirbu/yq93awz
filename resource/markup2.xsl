  ...
  <xsl:template match="/">
    <fo:root>
      ...
      <fo:page-sequence master-reference="my-sequence">
        ...
        <fo:block-container height="0.5cm" width="7.5in" margin-top="3mm" >
           <fo:block><fo:leader leader-pattern="rule" leader-length="6in" /> </fo:block>
        </fo:block-container>

       <xsl:for-each select="info_review/patient">
            <fo:block-container >
                <fo:block text-align="start" font-family="sans-serif" font-size="10pt">
                     Chart:          <xsl:value-of select="chart"/>
                     Patient:        <xsl:value-of select="name"/>
                 </fo:block>
	    </fo:block-container>
            <fo:block-container >
                <fo:block text-align="start" font-family="sans-serif" font-size="10pt">
			Ins1: <xsl:value-of select="case/ins1/code"/> 
			<fo:inline color="#ffffff"> ... </fo:inline> <!-- 3 blank -->
			<xsl:value-of select="case/ins1/name"/> 
                </fo:block>
	   </fo:block-container>
            <fo:block-container >
                <fo:block text-align="start" font-family="sans-serif" font-size="10pt">
			Ins2: <xsl:value-of select="case/ins2/code"/> 
			<fo:inline color="#ffffff"> ... </fo:inline> <!-- 3 blank -->
			<xsl:value-of select="case/ins2/name"/> 
                </fo:block>
	   </fo:block-container>
           <fo:block-container >
                <fo:block text-align="start" font-family="sans-serif" font-size="10pt">
	   ...
	   <!-- end of line -->
        ...
        <xsl:choose>
            <xsl:when test="stmt/summary">
                <fo:block-container width="7.9in" left="0.00in" margin-top="3mm" >
                    <fo:block><fo:leader leader-pattern="rule" leader-length="7.9in" /> </fo:block>
                </fo:block-container>
            </xsl:when>
        ...
        <xsl:for-each select="stmt/patient">
            ...
            <fo:block-container height="0.5cm" width="7.9in" left="0.00in" margin-top="3mm" >
               <fo:block><fo:leader leader-pattern="rule" leader-length="5in" /> </fo:block>
            </fo:block-container>
            ...
            <fo:block-container height="1cm" width="7.9in" left="0.00in" >
               <fo:block><fo:leader leader-pattern="rule" leader-length="7.9in" /> </fo:block>
            </fo:block-container>
            ...
            <fo:block-container height="1cm" width="7.9in" left="0.00in" font-family="sans-serif" 
               ...
               <fo:block>Billing questions:  <fo:inline font-weight="bold" font-size="11pt"> 
                ...
                <xsl:choose>
                        <xsl:when test="stmt/id &gt; 300">
                            <fo:block>
                                <fo:inline color="#ff00ff"> ID: <xsl:value-of select="stmt/id"/>
                                     </fo:inline></fo:block>
                        </xsl:when>
                        <xsl:otherwise>
                                <fo:block>ID: <xsl:value-of select="stmt/id"/></fo:block>
                        </xsl:otherwise>
                </xsl:choose>
