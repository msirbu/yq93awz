			...
			<fo:block-container width="7.5in" margin-top="6mm" text-align="start" font-family="sans-serif" font-size="10pt">
				<fo:block>
                    ...
                    <xsl:for-each select="error">
						<fo:block font-family="sans-serif" font-size="10pt" margin-top="2mm">
							<fo:inline color="red">
				...
				<fo:block start-indent=".5cm" end-indent=".5cm" margin-top="3mm">
				...
				<xsl:if test="not(normalize-space(signature/date))"> 
					<fo:block font-family="sans-serif" font-size="10pt" color="red">
						**ERROR: missing or empty signature/date**
		  			</fo:block>
				</xsl:if>
